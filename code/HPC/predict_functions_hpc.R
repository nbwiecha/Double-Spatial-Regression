# Prediction/estimation functions used in simulations for Two-Stage Estimators for Spatial Confounding
...
shift_dml = function(Y, D, S, shift=1, B){
  # Gilbert (2021) implemented shift estimator function
  # code copied from Gilbert (2021)
